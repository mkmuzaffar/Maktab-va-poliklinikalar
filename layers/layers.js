...
//ol.proj.get("EPSG:3857").setExtent([7686701.230900, 5031603.901528, 7745649.296356, 5075478.252531]);
var wms_layers = [];
...
var format_poliklinikajoylaripoliklinika_nuqta__joy_5 = new ol.format.GeoJSON();
var features_poliklinikajoylaripoliklinika_nuqta__joy_5 = format_poliklinikajoylaripoliklinika_nuqta__joy_5.readFeatures(json_poliklinikajoylaripoliklinika_nuqta__joy_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_poliklinikajoylaripoliklinika_nuqta__joy_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_poliklinikajoylaripoliklinika_nuqta__joy_5.addFeatures(features_poliklinikajoylaripoliklinika_nuqta__joy_5);cluster_poliklinikajoylaripoliklinika_nuqta__joy_5 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_poliklinikajoylaripoliklinika_nuqta__joy_5
});
var lyr_poliklinikajoylaripoliklinika_nuqta__joy_5 = new ol.layer.Vector({
                declutter: false,
                source:cluster_poliklinikajoylaripoliklinika_nuqta__joy_5, 
                style: style_poliklinikajoylaripoliklinika_nuqta__joy_5,
                popuplayertitle: "poliklinika joylari — poliklinika_nuqta__joy",
                interactive: true,
                title: '<img src="styles/legend/poliklinikajoylaripoliklinika_nuqta__joy_5.png" /> poliklinika joylari — poliklinika_nuqta__joy'
            });
var format_pn_6 = new ol.format.GeoJSON();
var features_pn_6 = format_pn_6.readFeatures(json_pn_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_pn_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_pn_6.addFeatures(features_pn_6);
var lyr_pn_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_pn_6, 
                style: style_pn_6,
                popuplayertitle: "pn",
                interactive: true,
                title: 'pn'
...
lyr_GoogleHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_Tashkentlayertashkent_2.setVisible(true);lyr_makpol15daqdissolved15__dissolved_3.setVisible(true);lyr_maktablarjoylarimaktab_nuqta_4.setVisible(true);lyr_poliklinikajoylaripoliklinika_nuqta__joy_5.setVisible(true);lyr_pn_6.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_OpenStreetMap_1,lyr_Tashkentlayertashkent_2,lyr_makpol15daqdissolved15__dissolved_3,lyr_maktablarjoylarimaktab_nuqta_4,lyr_poliklinikajoylaripoliklinika_nuqta__joy_5,lyr_pn_6];
...
lyr_poliklinikajoylaripoliklinika_nuqta__joy_5.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nomi': 'nomi', });
lyr_pn_6.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'nomi': 'nomi', });
...
lyr_poliklinikajoylaripoliklinika_nuqta__joy_5.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'nomi': 'TextEdit', });
lyr_pn_6.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'nomi': 'TextEdit', });
...
lyr_maktablarjoylarimaktab_nuqta_4.set('fieldLabels', {'fid': 'inline label - visible with data', 'full_id': 'inline label - visible with data', 'osm_id': 'inline label - visible with data', 'osm_type': 'no label', 'amenity': 'no label', 'telegram': 'no label', 'facebook': 'no label', 'contact_in': 'no label', 'contact_em': 'no label', 'religion': 'no label', 'internet_a': 'no label', 'internet_1': 'no label', 'grades': 'no label', 'contact_fa': 'no label', 'emergency_': 'no label', 'door': 'no label', 'maxwidth': 'no label', 'language_e': 'no label', 'name_kk': 'no label', 'addr_place': 'no label', 'motor_vehi': 'no label', 'access': 'no label', 'contact_ph': 'no label', 'office': 'no label', 'descriptio': 'no label', 'building': 'no label', 'addr_unit': 'no label', 'addr_city': 'no label', 'check_date': 'no label', 'phone': 'no label', 'opening_ho': 'no label', 'name_tr': 'no label', 'name_en': 'no label', 'email': 'no label', 'addr_stree': 'no label', 'addr_house': 'no label', 'ref': 'no label', 'website': 'no label', 'dispensing': 'no label', 'entrance': 'no label', 'alt_name': 'no label', 'historic': 'no label', 'school': 'no label', 'name_uz': 'no label', 'name_ru': 'no label', 'motorcycle': 'no label', 'motorcar': 'no label', 'horse': 'no label', 'foot': 'no label', 'bicycle': 'no label', 'operator': 'no label', 'barrier': 'no label', 'name': 'no label', 'highway': 'no label', 'bench': 'no label', 'addr_postc': 'no label', });
lyr_poliklinikajoylaripoliklinika_nuqta__joy_5.set('fieldLabels', {'fid': 'no label', 'id': 'no label', 'nomi': 'inline label - visible with data', });
lyr_pn_6.set('fieldLabels', {'fid': 'inline label - always visible', 'id': 'inline label - always visible', 'nomi': 'inline label - always visible', });
lyr_pn_6.on('precompose', function(evt) {
